...
const FAQ = () => {
  ...
  return (
    <div className="xs:px-[32px] lg:px-[120px] lg:mt-[150px] xs:mt-[60px] font-helvetica">
    <div className="bg-white xs:text-left xs:pb-[15px] lg:mb-[50px] mx-auto lg:text-center">
      <h1 className="xs:text-[24px] lg:text-[42px] xs:leading-[36px] font-bold   ">
        <span className="text-buttonCustomColor">Frequently </span>Asked
        Questions
      </h1>
      <p className=" xs:pt-[15px] xs:text-[14px] xs:leading-[18px] font-normal ">
              ...
              <div>
                ...
                >
                  <div className="flex gap-x-[13px]">
                    <div>
                      <p className="text-[24px] leading-[27px]  font-bold">
                        {item.number}
                      </p>
                    </div>
                    <h6 className="z-20 xs:text-[16px] lg:text-[24px] leading-[26px]  font-bold">
                      {item.question}
                    </h6>
                  </div>
                ...
                {openAccordion === item.id && (
                  <div>
                    <p className="xs:text-[12px] lg:text-[16px] leading-[28px] pl-[40px] pr-[26px] font-normal ">
                      {item.answer}
                    </p>
                  </div>
                )}
